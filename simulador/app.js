 ...
 * arranjos salvos na prancheta que o gerador embutiu (scripts/cenarios.py,
 * a mesma leitura que gera a lista da prancheta) e os que quem abre a pagina
 * carrega na hora, por colar ou por arquivo.
 ...
 * claude.ai e sem localStorage em comum. O que fecha essa distancia e a
 * prancheta exportar a biblioteca inteira num JSON so -- "Copiar tudo p/ o
 * simulador" -- que cai aqui em leArranjosDoTexto como lista. */
